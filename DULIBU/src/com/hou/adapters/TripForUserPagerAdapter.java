...
public class TripForUserPagerAdapter extends FragmentStatePagerAdapter {
    ...
    public TripForUserPagerAdapter(FragmentManager fm,CharSequence mTitles[], int mNumbOfTabsumb) {
        super(fm);
