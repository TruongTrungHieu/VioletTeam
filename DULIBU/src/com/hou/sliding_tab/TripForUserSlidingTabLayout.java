 ...
 * layout.
 */
public class TripForUserSlidingTabLayout extends HorizontalScrollView {
	/**
	...
	private final TripForUserSlidingTabStrip mTabStrip;

	private int currentPageSelected = 0;

	public TripForUserSlidingTabLayout(Context context) {
		this(context, null);
	}

	public TripForUserSlidingTabLayout(Context context, AttributeSet attrs) {
		this(context, attrs, 0);
	}

	public TripForUserSlidingTabLayout(Context context, AttributeSet attrs, int defStyle) {
		...
		mTabStrip = new TripForUserSlidingTabStrip(context);
	 ...
	 * {@link TripForUserSlidingTabLayout} you are required to set any
	...
	private void populateTabStrip() {
		/*final TripUserViewPagerAdapter adapter = (TripUserViewPagerAdapter) mViewPager.getAdapter();
		...
		final TripForUserViewPagerAdapter adapter = (TripForUserViewPagerAdapter) mViewPager.getAdapter();
	    final View.OnClickListener tabClickListener = new TabClickListener();
	...
	/*
	 * protected ImageView createDefaultImageView(Context context) { ImageView
	 ...
	 * mViewPager.getAdapter().getCount()); imageView.setMinimumWidth(width);
	 * 
	 * return imageView; }
	 */
